...
const Footer: React.FC = () => {
  return (
    <footer className="bg-secondary/30 dark:bg-accent/10 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Specifications</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Accessories</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Compare Models</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Warranty</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Returns</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Sustainability</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Trademarks</a></li>
            </ul>
          </div>
        </div>
